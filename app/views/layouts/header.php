...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo BASE_URL; ?>/logo/logo.png">
...
<header class="app-topnav">
  <div class="topnav-left">
    <a class="brand-link" href="<?php echo BASE_URL; ?>" style="display: inline-flex; align-items: center; gap: 10px; text-decoration: none; color: inherit;">
      <img src="<?php echo BASE_URL; ?>/logo/logo.png" alt="LibAI logo" style="width: 28px; height: 28px; object-fit: contain; border-radius: 8px; display: block;">
      <span>LibAI</span>
    </a>
  </div>
